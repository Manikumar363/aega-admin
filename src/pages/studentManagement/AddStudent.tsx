  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/45 px-4">
      <form onSubmit={handleSubmit} className="w-full max-w-4xl border border-[#2E325D] bg-[#14123A] p-4 sm:p-6">
        <h2 className="mb-5 text-3xl font-semibold text-white">Add Student</h2>

        <div className="space-y-4">
          <div>
            <label htmlFor="student-name" className="mb-2 block text-base text-white">
              Student Name<span className="text-[#E03137]">*</span>
            </label>
            <input
              id="student-name"
              type="text"
